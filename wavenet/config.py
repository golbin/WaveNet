...
parser.add_argument('--sample_rate', type=int, default=8000, help='Sampling rates for input sound')
parser.add_argument('--sample_size', type=int, default=5000, help='Sample size for training input')
...
def parse_args(is_training=True):
    if is_training:
        ...
        parser.add_argument('--decay_step', type=int, default=100, help='learning rate decay')
        parser.add_argument('--lr', type=float, default=0.002, help='learning rate decay')
    else:
